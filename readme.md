...
- after opening memori in your web browser, drag one or more image files from your computer onto the grid (or press `⌘ + v` to paste image data from your clipboard)<br>
