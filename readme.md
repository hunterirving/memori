...
| Other planners | Add a "grid-size" parameter to the url like so:<br>https://hunterirving.github.io/memori/?grid-size=5mm<br>This value can be anywhere between 2mm and 10mm. |
